    ...
    <main className="container grid min-h-screen items-center">
      <section>
        <header className="text-left">
          ...
          <p className="text-muted-foreground leading-none pl-3 mb-4">
            login with your favorite provider
          </p>
        </header>
        <div className="grid grid-cols-2 gap-4 max-w-xl">
          {/* <a href="/api/login/github" className={cn(buttonVariants())}>
            <Github size={28} />
            <span className="ml-2 font-semibold">Sign-In with GitHub</span>
          </a> */}
          ...
          {/* <a href="/api/login/mal" className={cn(buttonVariants())}>
            <svg
              role="img"
              width="28"
              height="28"
            ...
            <span className="ml-2 font-semibold">Sign-In with MyAnimeList</span>
          </a> */}
        </div>
      </section>
    </main>
